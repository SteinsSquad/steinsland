...
class TeleportAskCommand extends CustomCommand {

  public function __construct() {
    parent::__construct('tpa', 'teleport', 'steinscore.teleport.teleport', ['call']);
  ...
  public function onCommand(CommandSender $sender, array $args): int {
    ...
    SteinsTeleport::$instance->addTeleportRequest($sender, $player, SteinsTeleport::TYPE_TPA);
    $sender->sendLocalizedMessage('teleport.tpa-success', ['player' => $player->getCurrentName()]);
    $player->sendLocalizedMessage('teleport.tpa-request', ['player' => $sender->getCurrentName()]);
